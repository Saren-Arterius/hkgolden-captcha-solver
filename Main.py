...
captcha_url = "http://forum4.hkgolden.com/CheckImageCode.aspx"
captcha_length = 4
...
class CaptchaInputWindow(object):
    def __init__(self, parent):
        ...
        self.hint.set("Type in {0} characters to train.\nWhat characters did you see in the image below?".format(captcha_length))
    ...
    def entry_callback(self):
        if len(self.entry.get()) != captcha_length:
            return self.skip()
        self.solver.train(self.entry.get().upper())
